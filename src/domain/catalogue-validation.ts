...
export const SYSTEM_MANAGED_FIELDS: Record<string, readonly string[]> = Object.freeze({
  'api::reference-route.reference-route': ['currentInputFingerprint'],
  'api::route-city.route-city': ['currentInputFingerprint'],
  'api::city-itinerary.city-itinerary': ['currentEvaluationHash'],
